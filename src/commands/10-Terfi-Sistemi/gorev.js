...
`**İnvite Görev Durumu :** 
${staff} ${progressBar(gorevData ? gorevData.invite : 0, 20, 8)} \`${total} (${total}/20)\` 
` : "";
          //
...
`**Kayıt Görev Durumu :**  
${Muhabbet} ${progressBar(kayitgData ? kayitgData.kayit : 0, 50, 8)} \`${kayittotal} (${kayittotal}/50)\`
` : "";
          //
...
`**Mesaj Görev Durumu :**  
${mesaj2} ${progressBar(mesajData ? mesajData.mesaj : 0, 500, 8)} \`${mesajtotal} (${mesajtotal}/500)\`
` : "";
          //
...
`**Taglı Üye Durumu :**  
${galp} ${progressBar(tagData ? tagData.tagli : 0, 15, 8)} \`${tagTotal} (${tagTotal}/15)\`
` : "";
