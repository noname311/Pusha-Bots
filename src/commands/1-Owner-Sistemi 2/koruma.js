...
module.exports = {
  ...
  run: async (client, message, args,embed) => {
    if(!args[0]){
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "894935858531160065");//#OWNER
        yetki1.setPermissions(0);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "894935861362311189");//#Ceo
        yetki2.setPermissions(0);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "894935863123918898");//#Yıldız
