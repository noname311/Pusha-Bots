  ...
  ${miniicon} Günlük Mesaj: \`${Number(messageDaily).toLocaleString()} mesaj\`
   `, false);
    ...
    collector.on("collect", async (button) => {
      ...
      ${miniicon} Kayıtlar: \`${toplamData ? toplamData.toplams.length : 0} (Puan Etkisi: +${toplamData ? toplamData.toplams.length*1.25 : 0})\`
      ${miniicon} Taglılar: \`${taggedData ? taggedData.taggeds.length : 0} (Puan Etkisi: +${taggedData ? taggedData.taggeds.length*8 : 0})\`
      ${miniicon} Davetler: \`${total} (Puan Etkisi: +${total*2})\`
      ${miniicon} Yetkililer: \`${yetkiData ? yetkiData.yetkis.length : 0} kişi (Puan Etkisi: +${yetkiData ? yetkiData.yetkis.length*8 : 0})\`
      ${miniicon} Chat Puan: \`${messageData ? messageData.topStat : 0} mesaj (Puan Etkisi: +${messageData ? messageData.topStat*1 : 0})\`
      ${miniicon} Sesli Puan: \`${moment.duration(voiceData ? voiceData.topStat : 0).format("m")} dakika (Puan Etkisi: +${moment.duration(voiceData ? voiceData.topStat : 0).format("m")*0.25})\`
       `, false)
...
`) 
.addField(`${star} **Puan Detayları:**`, `
${miniicon} Kayıt: (\`Puan Etkisi: +${toplamData ? toplamData.toplams.length*1.25 : 0}\`)
${miniicon} Taglı: (\`Puan Etkisi: +${taggedData ? taggedData.taggeds.length*8 : 0}\`)
${miniicon} Davet: (\`Puan Etkisi: +${total*2}\`)
${miniicon} Yetkili: (\`Puan Etkisi: +${yetkiData ? yetkiData.yetkis.length*8 : 0}\`)
${miniicon} Toplam Ses: (\`Puan Etkisi: +${moment.duration(voiceData ? voiceData.topStat : 0).format("m")*0.25}\`)
...
${miniicon} Kayıt işlemi yaparak, \`+1.25\` puan kazanırsın.
${miniicon} Taglı üye belirleyerek, \`+8\` puan kazanırsınız.
${miniicon} İnsanları davet ederek, \`+2\` puan kazanırsın.
${miniicon} İnsanları yetkili yaparak, \`+8\` puan kazanırsın.
${miniicon} Seste kalarak, ortalama olarak \`+0.25\` puan kazanırsınız.
